...
Phase 5 is complete (`EventDrivenBacktest` with `ExecutionEngine` and
`IndianEquityCostModel`). Next is **Phase 6** — cross-sectional pipelines:
`Pipeline`, `Factor`, `Filter`, and universe ranking for multi-asset selection.
